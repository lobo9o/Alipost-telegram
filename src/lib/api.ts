...
export const postsApi = {
  ...
  publish: (id: string, payload: { post: CreatedPost; layoutContenuto?: string; keyboardContenuto?: string; generatedImage?: string; disableNotification?: boolean; channelOverride?: string }) =>
