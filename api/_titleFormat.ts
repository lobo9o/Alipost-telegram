...
const KEYWORD_RULES: Array<{ re: RegExp; emoji: string }> = [
  ...
  { re: /\b(monitor)\b|\b(display)\b.{0,15}(pollici|inch|4k|2k|qhd|fhd|ips|va|oled)/i, emoji: '🖥️' },
  { re: /\bmsi\b.{0,15}(mag|optix|artymis)\b/i, emoji: '🖥️' },
  { re: /\b(144hz|165hz|240hz|360hz|120hz|75hz)\b/i, emoji: '🖥️' },
  ...
  // ── Audio ──────────────────────────────────────────────────────────────────
  { re: /\b(airpods|cuffie|auricolar[ei]?|headphone|earphone|earbuds|in-ear)\b/i, emoji: '🎧' },
  { re: /\b(speaker|altoparlant[ei]?|cassa.{0,8}bluetooth|soundbar|subwoofer)\b/i, emoji: '🔊' },

  // ── TV & Video ─────────────────────────────────────────────────────────────
  { re: /\b(smart tv|fire.?tv|fire stick|televisore|oled tv|qled|neo qled|mini.?led tv)\b/i, emoji: '📺' },
  ...
  { re: /\b(adattatore|dongle).{0,20}(bluetooth|usb.{0,8}(wireless|wifi))|\b(bluetooth|wifi).{0,15}(adattatore|dongle|nano.?usb)\b/i, emoji: '📡' },
  ...
  { re: /\b(aspirapolvere|scopa.{0,10}elettrica|dyson|swiffer|cattura.{0,8}polvere|sweeper|mocio)\b/i, emoji: '🧹' },

  // ── Lavatrici & Grandi Elettrodomestici ───────────────────────────────────
  { re: /\b(ferro.{0,15}(stiro|vapore)|generatore.{0,10}vapore|stiratrice|stiratore)\b/i, emoji: '🧺' },
  ...
  { re: /\b(montalatte|milk.?frother|schiumalatte)\b/i, emoji: '☕' },
  ...
  { re: /\b(sdraio|prendisole|lettino.{0,10}(spiaggia|mare|piscina|outdoor|esterno))\b/i, emoji: '🪑' },
  { re: /\b(sedia|poltrona|divano|pouf)\b/i, emoji: '🪑' },
  { re: /\b(tavolo|scrivania|libreria|scaffale|armadio|comodino)\b/i, emoji: '🪑' },
  { re: /\b(tenda|tende|veneziana|rullo.{0,10}oscurante)\b/i, emoji: '🪟' },
  ...
  { re: /\b(profumatore|deodorante.{0,15}ambiente)\b/i, emoji: '🌸' },
  ...
  // ── Shampoo & Doccia ──────────────────────────────────────────────────────
  { re: /\bdove\b.{0,25}(doccia|shampoo|men|care|body|wash|gel|spray|deodorante)\b/i, emoji: '🧴' },
  { re: /\b(shampoo|balsamo|doccia.?schiuma|bagno.?schiuma|bagnoschiuma|bagnodoccia|bagno.?doccia|doccia\b|sapone|deodorante|roll.?on|body.?spray|borotalco|talco.{0,10}(corpo|baby|bambin))\b/i, emoji: '🧴' },
  ...
  { re: /\b(borsa|borsetta|clutch|pochette|shopper|\bbag\b)\b/i, emoji: '👜' },
  { re: /\b(portafoglio|portafogli|wallet)\b/i, emoji: '👛' },
  ...
  // ── Alimentari ────────────────────────────────────────────────────────────
  { re: /\b(cereali|muesli|granola|corn.?flakes|fiocchi.{0,10}(avena|mais)|kellogg|weetabix|choco.?pops)\b/i, emoji: '🥣' },
  ...
  // ── Giardinaggio ──────────────────────────────────────────────────────────
  { re: /\b(troncatrice|motosega|chainsaw|sega.{0,15}catena)\b/i, emoji: '🪚' },
  ...
  { re: /\b(astuccio|astucci|zaino.{0,10}scuola|cartella.{0,10}scuola)\b/i, emoji: '✏️' },
  ...
  { re: /\b(pattumiera|cestino)\b/i, emoji: '🗑️' },
  ...
  // ── Smart (fallback generico — deve stare DOPO tutte le altre regole) ────────
  { re: /\bsmart\b/i, emoji: '📱' },
];

// Regole sulla categoria Amazon/AliExpress (fallback se nessuna keyword matcha)
const CAT_RULES: Array<{ re: RegExp; emoji: string }> = [
  { re: /informatica|computer|periferiche|networking|componenti.?pc|computer.?office|electronic.?components/i, emoji: '💻' },
  { re: /elettronica|high.tech|consumer.?electronics/i, emoji: '💻' },
  { re: /telefon|smartphone|cellulari|phones?.?telecommunication/i, emoji: '📱' },
  { re: /tv|televisori|home.?video|streaming/i, emoji: '📺' },
  { re: /fotografia|videocamere|cameras?.?photo/i, emoji: '📷' },
  { re: /videogiochi|gaming|video.?games?.?consoles/i, emoji: '🎮' },
  { re: /audio|hi-fi|altoparlanti/i, emoji: '🔊' },
  { re: /grandi.?elettrodomestici|home.?appliances/i, emoji: '🧺' },
  { re: /piccoli.?elettrodomestici/i, emoji: '🍳' },
  { re: /cucina|kitchen/i, emoji: '🍳' },
  { re: /giardino|giardinaggio|garden|patio|lawn|home.?.?garden/i, emoji: '🌱' },
  { re: /bricolage|fai.da.te|ferramenta|tools|home.?improvement/i, emoji: '🔧' },
  { re: /arredamento|furniture|casa/i, emoji: '🏠' },
  { re: /abbigliamento|moda|fashion|apparel|clothing/i, emoji: '👕' },
  { re: /scarpe|calzature|footwear|shoes/i, emoji: '👟' },
  { re: /borse|luggage|valigie|travel.bags/i, emoji: '🧳' },
  { re: /gioielli|orologi|jewelry|watches/i, emoji: '💍' },
  { re: /alimentar|gastronomia|cibo|grocery|food|beverages/i, emoji: '🛒' },
  ...
  { re: /animali|pet.?supplies|animals/i, emoji: '🐾' },
  { re: /ufficio|cancelleria|lavoro|office|school.?supplies/i, emoji: '💼' },
  { re: /musica|strumenti|musical/i, emoji: '🎵' },
  { re: /luci|lighting|lights/i, emoji: '💡' },
  { re: /sicurezza|security|protection/i, emoji: '🔒' },
];
